...
| PAR-ROUTE-030 | Virtual key routing via `x-g0-vk` header | `.planning/phases/08-keys-virtualkeys-routing/PLAN.md:46` | PARTIAL | Stage-1 half (w5-g): x-g0-vk gate + per-provider model constraints + quota + spend attribution; KeyIDs upstream-key pinning → W6 with PAR-ROUTE-057/058 |
