...
| PAR-BF-OAI-002 | Route `POST /v1/completions` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:723` | MISSING | Schema exists (`internal/schemas/completions.go:4-21`) but no route registered |
...
| PAR-BF-OAI-007 | Route `POST /v1/audio/speech` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:729` | MISSING | Schema exists (`internal/schemas/audio.go:4-10`) but no route; provider stubbed (`stubs.go:41-47`) |
| PAR-BF-OAI-008 | Route `POST /v1/audio/transcriptions` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:730` | MISSING | Schema exists (`internal/schemas/audio.go:18-27`) but no route; provider stubbed (`stubs.go:49-55`) |
| PAR-BF-OAI-009 | Route `POST /v1/images/generations` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:731` | MISSING | Schema exists (`internal/schemas/images.go:4-13`) but no route; provider stubbed (`stubs.go:25-31`) |
| PAR-BF-OAI-010 | Route `POST /v1/images/edits` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:734` | MISSING | Schema exists (`internal/schemas/images.go:28-38`) but no route; provider stubbed (`stubs.go:33-39`) |
| PAR-BF-OAI-011 | Route `POST /v1/images/variations` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:735` | MISSING | Schema exists (`internal/schemas/images.go:40-48`) but no route; provider stubbed (`stubs.go:37-39`) |
...
| PAR-BF-OAI-019 | Route `GET /v1/models/{id}` registered with fasthttp | `transports/bifrost-http/integrations/openai.go:1351` | PARTIAL | Route exists (`internal/server/routes_openai.go:18`) but handler delegates to `List` with no filtering (`internal/api/models.go:51-53`) |
| PAR-BF-OAI-020 | Route `POST /v1/batches` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:757` | MISSING | Schema exists (`internal/schemas/batch.go:45-51`) but no route; provider stubbed (`stubs.go:77-91`) |
| PAR-BF-OAI-021 | Route `GET /v1/batches` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:758` | MISSING | Schema exists (`internal/schemas/batch.go:53-57`) but no route; provider stubbed |
| PAR-BF-OAI-022 | Route `GET /v1/batches/{batch_id}` registered with fasthttp | `transports/bifrost-http/handlers/inference.go:759` | MISSING | Schema exists (`internal/schemas/batch.go:4-22`) but no route; provider stubbed |
| PAR-BF-OAI-023 | Route `POST /v1/batches/{batch_id}/cancel` registered | `transports/bifrost-http/handlers/inference.go:760` | MISSING | No route; provider stubbed |
| PAR-BF-OAI-024 | Route `GET /v1/batches/{batch_id}/results` registered | `transports/bifrost-http/handlers/inference.go:761` | MISSING | No route; provider stubbed |
| PAR-BF-OAI-025 | Route `POST /v1/files` (upload) registered with fasthttp | `transports/bifrost-http/handlers/inference.go:770` | MISSING | Schema exists (`internal/schemas/files.go:15-20`) but no route; provider stubbed (`stubs.go:57-75`) |
| PAR-BF-OAI-026 | Route `GET /v1/files` (list) registered with fasthttp | `transports/bifrost-http/handlers/inference.go:771` | MISSING | Schema exists (`internal/schemas/files.go:22-26`) but no route; provider stubbed |
| PAR-BF-OAI-027 | Route `GET /v1/files/{file_id}` (retrieve) registered | `transports/bifrost-http/handlers/inference.go:772` | MISSING | Schema exists (`internal/schemas/files.go:4-13`) but no route; provider stubbed |
| PAR-BF-OAI-028 | Route `DELETE /v1/files/{file_id}` registered | `transports/bifrost-http/handlers/inference.go:773` | MISSING | No route; provider stubbed |
| PAR-BF-OAI-029 | Route `GET /v1/files/{file_id}/content` registered | `transports/bifrost-http/handlers/inference.go:774` | MISSING | No route; provider stubbed |
...
| PAR-BF-OAI-207 | Text completion streaming supported | `transports/bifrost-http/handlers/inference.go:723` | MISSING | Provider stubbed (`stubs.go:13-15`) |
...
| PAR-BF-OAI-209 | Speech streaming supported | `transports/bifrost-http/handlers/inference.go:729` | MISSING | Provider stubbed (`stubs.go:45-47`) |
| PAR-BF-OAI-210 | Transcription streaming supported | `transports/bifrost-http/handlers/inference.go:730` | MISSING | Provider stubbed (`stubs.go:53-55`) |
| PAR-BF-OAI-211 | Image generation streaming supported | `transports/bifrost-http/handlers/inference.go:731` | MISSING | Provider stubbed (`stubs.go:29-31`) |
