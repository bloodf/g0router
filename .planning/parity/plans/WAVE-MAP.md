...
| w1-k | gemini client request translator ONLY *(restructured 2026-06-10: the request-pipeline helpers below have no Wave-1 consumer — they are called by the routing layer's translateRequest preprocessing, so they ship in Wave 4 WITH their integration, addressing the gate's "dead helper" finding)* | `gemini-to-openai.js` request (147) | PAR-TRANS-066 |
| w4-pre (Wave 4) | request-pipeline preprocessing helpers + integration into the routing translateRequest path | `index.js:58-72` strip, `toolDeduper.js` (49), `reasoningContentInjector.js` (79) | PAR-TRANS-006, 053, 051, 052 |
| w1-l | claude pipeline helpers (split from w1-k 2026-06-10: cohesive cloaking/signature/appConstants deps) | `claudeCloaking.js` (155), `bypassHandler.js` (195), `claudeHelper.js:81-215`, appConstants/signature | PAR-TRANS-022, 054, 055; 057 verified vs w1-b |
