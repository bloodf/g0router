...
func TestNewBuildsReplicateOpenAICompatibleProvider(t *testing.T) {
	var gotPath string
	var gotAuth string
...
func testKey() providers.Key {
	return providers.Key{Value: "test-key", Provider: providers.ProviderReplicate, ConnID: "conn-1", AuthType: "api_key"}
}
