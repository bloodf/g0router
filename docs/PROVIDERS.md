...
Current public direct-dispatch providers are `openai`, `alibaba`, `anthropic`, `azure`, `bedrock`, `cerebras`, `cloudflare-ai-gateway`, `cohere`, `deepseek`, `fireworks`, `gemini`, `github-copilot`, `groq`, `huggingface`, `litellm`, `lm-studio`, `mistral`, `minimax`, `nebius`, `nvidia`, `ollama`, `openrouter`, `perplexity`, `qianfan`, `qwen`, `together`, `vercel-ai-gateway`, `vertex`, `vllm`, `xai`, and `zhipu`. Providers without a static catalog use provider-qualified model names such as `alibaba/<model>`, `azure/<deployment>`, `cloudflare-ai-gateway/<author>/<model>`, `github-copilot/<model>`, `qianfan/<model>`, `vllm/<served-model>`, or `zhipu/<model>`.
