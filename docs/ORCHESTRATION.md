...
| 8 | 44 | 8 | completion hardening tracked in WORKFLOW.md as Waves 8.L–8.BC |
...
OpenAI-compatible runtime routing, Cursor OMP-style polling auth, and Cursor
OAuth poll completion remediation through Wave 8.BC.
