...
| 8 | 37 | 8 | completion hardening Waves 8.A–8.AK |
...
runtime dispatch, selected MCP OAuth account binding, and MCP OAuth client
credential propagation through Wave 8.AK.
