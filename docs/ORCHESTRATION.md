...
| 8 | 37 | 8 | completion hardening tracked in WORKFLOW.md as Waves 8.L–8.AV |
| **Total** | **63 waves** | — | **77 original tasks + remediation + completion hardening** |
...
SSE streaming parity, and Vertex native SSE streaming parity through Wave 8.AV.
