...
| 8 | 45 | 8 | completion hardening Waves 8.A–8.AS |
| **Total** | **71 waves** | — | **77 original tasks + remediation + completion hardening** |
...
and Phase 12 completed-data-model wording through Wave 8.AS.
