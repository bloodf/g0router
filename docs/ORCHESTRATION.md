...
| 8 | 38 | 8 | completion hardening tracked in WORKFLOW.md as Waves 8.L–8.AW |
| **Total** | **64 waves** | — | **77 original tasks + remediation + completion hardening** |
...
SSE streaming parity, Vertex native SSE streaming parity, and Bedrock signed
model listing parity through Wave 8.AW.
